# -*- encoding: utf-8 -*-
# stub: activerecord-postgis-adapter 9.0.2 ruby lib

Gem::Specification.new do |s|
  s.name = "activerecord-postgis-adapter".freeze
  s.version = "9.0.2".freeze
  ...
  s.add_runtime_dependency(%q<activerecord>.freeze, ["~> 7.1.0".freeze])
  ...
  s.add_development_dependency(%q<benchmark-ips>.freeze, ["~> 2.12".freeze])
